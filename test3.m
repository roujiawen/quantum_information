...
results_data_path = 'results/test3_infea_full_xu_low';
...
load(test_data_path);
ntrials = size(test_cases, 2);
results_data_path = 'results/test3_infea_CG_xu_low';
...
load(test_data_path);
ntrials = size(test_cases, 2);
results_data_path = 'results/test3_fea_full_xu_low';
...
load(test_data_path);
ntrials = size(test_cases, 2);
results_data_path = 'results/test3_fea_CG_xu_low';
...
load(test_data_path);
ntrials = size(test_cases, 2);
results_data_path = 'results/test3_infea_CG_after350_up';
...
load(test_data_path);
ntrials = size(test_cases, 2);
results_data_path = 'results/test3_fea_CG_after350_up';
